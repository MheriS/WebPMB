...
<head>
    ...
    <!-- Modal Boootstrap Lulus/Tidak Lulus-->
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="panitiahasilpeserta.php?nama_jurusan= <?php echo $data['nama_jurusan']; ?>">Hasil Peserta PMB <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <main role="main" class="container">
        ...
        <tbody>
            ...
            include "koneksi.php";
            $no=1;
            $a="SELECT a.nilai, b.nama, c.nama_jurusan FROM hasil a inner join maba b on a.id_maba=b.id_maba INNER JOIN jurusan c ON c.id_jurusan=b.id_jurusan where nama_jurusan = '$jurusan'";
            $b=$koneksi->query($a);
