...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <main role="main" class="container">
        ...
        <div class="text-center mt-5 pt-5">
            <h1>Selamat Datang Panitia PMB</h1>
            <p class="lead">Pembuatan aplikasi 'Penerimaan Mahasiswa Baru' berbasis website ini bertujuan untuk membantu peserta/calon mahasiswa melakukan proses pendaftaran, mengecek persyaratan, mengunggah dokumen yang diperlukan, melakukan pembayaran, mengecek jadwal dan lokasi ujian, serta dapat mengunduh kartu peserta secara online</p>
