...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <fieldset>
            ...
            <div class="first">
        <center>
        <form method="POST" action="aksipanitiainputsoal.php" enctype="multipart/form-data">
            <table>
                <tr>
                ...
                <tr>
                    <td>Soal</td>
                    <td><input type="text" id="soal" placeholder="Masukkan soal Anda" name="soal" style="width:800px; border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive;; margin-left:8px;"></td>
                </tr>
                <tr>
                    <td>A.</td>
                    <td><input type="text" id="a" placeholder="Masukkan jawaban A" name="a" style="width:800px; border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive; margin-left:8px;"></td>
                </tr>
                
                <tr>
                    <td>B.</td>
                    <td><input type="text" id="b" placeholder="Masukkan jawaban B" name="b" style="width:800px;  border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive;; margin-left:8px;"></td>
                </tr>
                <tr>
                    <td>C.</td>
                    <td><input type="text" id="c" placeholder="Masukkan jawaban C" name="c" style="width:800px; border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive;; margin-left:8px;"></td>
                </tr>
                <tr>
                    <td>D.</td>
                    <td><input type="text" id="d" placeholder="Masukkan jawaban D" name="d" style="width:800px; border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive;; margin-left:8px;"></td>
                </tr>
                <tr>
                    <td>E.</td>
                    <td><input type="text" id="e" placeholder="Masukkan jawaban E" name="e" style="width:800px; border:1px dotted #c6c9c6; border-radius:4px; -moz-border-radius:4px; background:#f6fff8; height:20px; font-family: 'Handlee', cursive;; margin-left:8px;"></td>
                </tr>
                <tr>
                    <td>Kunci Jawaban</td>
...
//            error_reporting(0);
            ...
            <tr>
                ...
                <td align="center"><a href="panitiaeditsoal.php?id=<?php echo $c['id']; ?>"><button>Edit</button></a><a onclick="return confirm ('Yakin Ingin Menghapus Soal Tersebut?')" href="aksihapuspanitiasoal.php?id= <?php echo $c['id']; ?>"><button>Hapus</button></a></td>             
            </tr>
            <?php
            }
            ?>
