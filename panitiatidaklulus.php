...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item  active">
                <a class="nav-link" href="panitiatidaklulus.php?nama_jurusan= <?php echo $data['nama_jurusan']; ?>">Data Peserta Tidak Lulus <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <main role="main" class="container">
        ...
        <div class="text-center mt-5 pt-5">
            <h1>Data Peserta PMB Nilai Tidak Memenuhi</h1>
        ...
        <tbody>
            ...
            include "koneksi.php";
            $no=1;
            $a="SELECT b.nilai, b.id_hasil, c.nama, d.nama_jurusan, b.keterangan FROM hasil b INNER JOIN maba c ON b.id_maba=c.id_maba INNER JOIN jurusan d ON c.id_jurusan=d.id_jurusan where keterangan = 'Tidak Memenuhi' AND nama_jurusan = '$jurusan' order by nilai desc";
