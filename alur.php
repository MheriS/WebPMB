...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="alur.php">Alur PMB <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <main role="main" class="container">
        ...
        <div class="text-center mt-5 pt-5">
            <h1>Alur PMB</h1>
            <center>
        <!--<img src="alur.png" width="776" height="419">-->
              <?php
            include "koneksi.php";
            $a="SELECT gambar FROM alur";
            $b=$koneksi->query($a);
            while($c=$b->fetch_array()){
                ?>
                <img src="img/<?php echo $c['gambar'];?>" width="776px" height="419">
                <?php  
            }
            ?>  
            </center>
